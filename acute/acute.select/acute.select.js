        ...
        return {
            ...
            controller: function($scope, $element, $window, $rootScope, $timeout, $filter, navKey, safeApply) {
                ...
                function fireChangeEvent() {
                    ...
                    if (typeof $scope.acChange === 'function') {
                        $scope.acChange({
                            value: $scope.selectedItem ? $scope.selectedItem.value : null
                        });
                    }
                }
...
.factory('acuteSelectService', function() {
    ...
    var defaultSettings = {
        ...
        "noItemsText": "No recommended items match.",
        "placeholderText": "Input or select ...",
        "itemHeight": 24,
        "itemsInView": 10,
        "pageSize": null,
        "minWidth": "100px",
